...
#    def add_flowgages(self, gageid, comid):
#        """Adds a path to an NWIS gage data file."""

#        self.flowgages[gageid] = comid
    ...
    def save_calibration(self, base_values, process_dates = None, 
        ...
        folder = '{0}/{1}/calibrations'.format(self.directory, self.HUC8)
    ...
    def save_figures(self, base_values, gage, run = True, process_dates = None,
                     snow = False, hydrograph = False, runoff = False, 
                     storms = False, calibration = False):
